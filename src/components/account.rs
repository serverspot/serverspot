...
use crate::gravatar::{CURRENT_USER_EMAIL, CURRENT_USER_NAME};
...
pub fn Account() -> Element {
    ...
    rsx! {
        ...
        section {
            class: "mb-6 flex flex-col gap-4 rounded-squircle-lg border border-border-subtle bg-surface/20 p-4 sm:mb-8 sm:flex-row sm:items-center sm:gap-5 sm:p-5",
            Avatar {
            ...
            div {
                ...
                p { class: "text-lg font-semibold tracking-tight", "{CURRENT_USER_NAME}" }
                p { class: "mt-0.5 text-sm text-text-muted", "{CURRENT_USER_EMAIL}" }
        ...
        div {
            ...
            DataPanel {
                ...
                div { class: "flex flex-col gap-4",
                    Field {
                        label: "Display name",
                        StaticInput { value: CURRENT_USER_NAME }
                    }
                    Field {
                        label: "Email",
                        StaticInput { value: CURRENT_USER_EMAIL }
                    }
                    Field {
                        label: "Bio",
