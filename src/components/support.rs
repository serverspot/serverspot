...
pub fn SupportTickets() -> Element {
    rsx! {
        ...
        div {
            ...
            DataPanel {
                title: "Open tickets",
                RowItem { title: "#1842 · Payment not received", meta: "Store · High priority · Unassigned", trailing: "11m" }
                RowItem { title: "#1839 · Can't join lobby", meta: "Gameplay · Normal · Assigned Mira", trailing: "34m" }
                RowItem { title: "#1833 · Rank missing perks", meta: "Store · Normal · Internal note added", trailing: "1h" }
                RowItem { title: "#1828 · Ban appeal", meta: "Moderation · Low · History: 2 prior", trailing: "3h" }
            }
            DataPanel {
    ...
    rsx! {
        ...
        div {
            ...
            DataPanel {
                ...
                RowItem { title: "How to claim vote rewards", meta: "Guides · Featured", trailing: "2.1k views" }
                RowItem { title: "Server rules", meta: "Rules · Pinned", trailing: "1.4k views" }
                RowItem { title: "Connecting with Bedrock", meta: "Tutorials", trailing: "980 views" }
                RowItem { title: "Store refund policy", meta: "Documentation", trailing: "640 views" }
            }
        }
    }
}
