...
pub fn ContentBlog() -> Element {
    rsx! {
        ...
        div { class: "grid gap-4 lg:grid-cols-2",
            DataPanel { title: "Publishing features",
                FeatureBullets {
            ...
            DataPanel { title: "Recent posts",
                RowItem {
                    title: "Season 4 launch recap",
                    meta: "News · Published · Featured",
                    trailing: "Today",
                }
                RowItem {
                    title: "Economy changes",
                    meta: "Blog · Draft · Needs approval",
                    trailing: "Edit",
                }
                RowItem {
                    title: "Weekend crate event",
                    meta: "News · Scheduled Fri 18:00",
                    trailing: "Queue",
                }
                RowItem {
                    title: "Builder spotlight",
                    meta: "Blog · Homepage placement",
                    trailing: "Live",
                }
            }
        }
...
pub fn ContentPages() -> Element {
    rsx! {
        ...
        div { class: "grid gap-4 lg:grid-cols-2",
            ...
            DataPanel { title: "Pages & widgets",
                RowItem {
                    title: "Homepage slider",
                    meta: "3 slides · Autoplay on",
                    trailing: "Live",
                }
                RowItem {
                    title: "Staff page",
                    meta: "12 members listed",
                    trailing: "Live",
                }
                RowItem {
                    title: "Changelog",
                    meta: "Last entry 2 days ago",
                    trailing: "Live",
                }
                RowItem {
                    title: "Popup promo",
                    meta: "SUMMER20 banner",
                    trailing: "Scheduled",
                }
