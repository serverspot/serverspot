...
pub fn Login() -> Element {
    rsx! {
        div { class: "relative flex h-dvh flex-col overflow-y-auto bg-bg text-text",
            div {
            ...
            div { class: "relative flex flex-1 flex-col items-center justify-center px-4 py-10",
                div { class: "w-full max-w-sm",
                    ...
                    div { class: "flex flex-col gap-4 rounded-squircle-lg border border-border-subtle bg-surface/30 p-5 sm:p-6",
                        ...
                        Button { class: "mt-1", full_width: true, "Sign in" }
                    }
                }
            }
            div { class: "relative", PoweredByFooter {} }
        }
    }
}
