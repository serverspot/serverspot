...
pub fn AnalyticsWebsite() -> Element {
    rsx! {
        ...
        div { class: "grid gap-4 lg:grid-cols-2",
            ...
            DataPanel { title: "Traffic & pages",
                RowItem {
                    title: "Direct",
                    meta: "Returning players",
                    trailing: "38%",
                }
                RowItem {
                    title: "Discord",
                    meta: "Invite & announcements",
                    trailing: "27%",
                }
                RowItem { title: "Search", meta: "Organic", trailing: "18%" }
                RowItem {
                    title: "Vote sites",
                    meta: "Reward campaigns",
                    trailing: "17%",
                }
                RowItem {
                    title: "/store",
...
pub fn AnalyticsGaming() -> Element {
    rsx! {
        ...
        DataPanel { title: "Server activity",
            RowItem {
                title: "Survival",
                meta: "Avg 186 online · Economy climbing",
                trailing: "Healthy",
            }
            RowItem {
                title: "Skyblock",
                meta: "Avg 94 online · Vote claims up",
                trailing: "Healthy",
            }
            RowItem {
                title: "Creative",
                meta: "Avg 41 online · Builder spike weekends",
                trailing: "Steady",
            }
